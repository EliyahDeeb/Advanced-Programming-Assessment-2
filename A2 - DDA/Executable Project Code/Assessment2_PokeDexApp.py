...
# Creating the main window of the PokéDex.
window = tk.Tk()
...
# Frame for the Pokémon’s sprite image.
...
# Frame for the Pokémon’s basic info.
...
# Frame for the Pokémon’s base stats.
stats_frame = tk.Frame(window, bd=2, relief="solid", padx=10, pady=10)  # Added border
stats_frame.pack(pady=10)

# Create progress bars for the Pokémon’s stats.
...
# Frame for a Pokémon’s abilities.
...
# Frame for a Pokémon’s evolution chain.
